      ...
      <main style={{ paddingTop: 64 }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
                ...
                <Link href="#how" style={{
                  ...
                  border: '1px solid #252a45', color: '#8892b0',
        ...
        <section style={{ background: '#0f1225', borderTop: '1px solid #1e2340', borderBottom: '1px solid #1e2340', padding: '32px 32px' }}>
          <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24, textAlign: 'center' }} className="stats-grid">
            {STATS.map(s => (
              <div key={s.label}>
                <div style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 'clamp(1.6rem, 3vw, 2.4rem)', fontWeight: 700,
        ...
        <section style={{ padding: '0 32px 64px', maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            background: 'linear-gradient(135deg, #1a1035 0%, #141728 50%, #0f1a2e 100%)',
            border: '1px solid #252a45',
            borderRadius: 20,
            padding: '48px 48px',
        ...
        <section style={{ padding: '0 32px 96px', maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32 }}>
            ...
            <Link href="/register" style={{ fontSize: 13, color: '#9d5cff', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>View all →</Link>
          </div>
        ...
        <section style={{ padding: '80px 32px', maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32 }}>
            <div>
              ...
              <h2 style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 'clamp(1.4rem,3vw,2rem)', fontWeight: 700 }}>Crypto Markets</h2>
            </div>
          </div>
          <div style={{ background: '#141728', border: '1px solid #252a45', borderRadius: 16, overflow: 'hidden' }}>
            {COINS.map((c, i) => (
              <div key={c.symbol} style={{
                display: 'grid', gridTemplateColumns: '40px 1fr 1fr 1fr', alignItems: 'center',
                padding: '18px 24px', gap: 16,
                borderBottom: i < COINS.length - 1 ? '1px solid #1e2340' : 'none',
        ...
        <section style={{ padding: '0 32px 96px' }}>
          <div style={{
            ...
            background: 'linear-gradient(135deg, #2d1b69 0%, #1e3a6e 100%)',
